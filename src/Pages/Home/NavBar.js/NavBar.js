        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <Link to='/allmenu'><button className='btn btn-outline lg:text-2xl text-sm'>All Menu</button></Link>
            ...
            <div className="navbar-center hidden lg:flex">
                ...
                <Link to='/allmenu'><button className='btn btn-outline border-2 lg:text-2xl text-sm'>All Menu</button></Link>
